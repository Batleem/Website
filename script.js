...
interest_sport: "Course à pied",
interest_music: "Piano & Musique",

        title_lang: "Langues",
        lang_fr: "Français", lang_en: "Anglais", lang_es: "Espagnol", lang_cn: "Chinois",

        title_skills: "Compétences techniques", skill_cat_dev: "Développement", skill_cat_data: "Système & Data",
       ...
       proj_1_title: "Clone Leboncoin (Laravel)",
        ...
        contact_text: "Prêt à rejoindre votre équipe technique."
    },
    en: {
        ...
        interest_dev: "Dev & Tech",
interest_manga: "Manga (20th Century Boys)",
interest_sport: "Running",
interest_music: "Piano & Music",

        title_lang: "Languages",
        lang_fr: "French", lang_en: "English", lang_es: "Spanish", lang_cn: "Chinese",

        title_skills: "Skills", skill_cat_dev: "Development", skill_cat_data: "System & Data",
        ...
        proj_1_date: "November 2025 - recent",
        ...
        proj_site_date: "Nov 2025 - recent", 
        ...
        contact_text: "Ready to join your technical team."
    }
};
...
function setLanguage(lang) {
    ...
    keys.forEach(key => {
    // UTILISER querySelectorAll POUR TOUT TROUVER
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // --- SYNCHRO LANGUE MOBILE ---
    // Pour que les boutons de langue du menu mobile marchent aussi
    const mobBtnFr = document.getElementById('mob-btn-fr');
    const mobBtnEn = document.getElementById('mob-btn-en');

    if (mobBtnFr) mobBtnFr.addEventListener('click', () => {
        setLanguage('fr');
        updateMobileActiveLang('fr');
    });
    
    if (mobBtnEn) mobBtnEn.addEventListener('click', () => {
        setLanguage('en');
        updateMobileActiveLang('en');
    });

    function updateMobileActiveLang(lang) {
        // Met à jour le style active des boutons mobiles
        document.querySelectorAll('.mobile-lang-switch .lang-btn').forEach(btn => btn.classList.remove('active'));
        const activeBtn = document.getElementById(`mob-btn-${lang}`);
        if(activeBtn) activeBtn.classList.add('active');
    }
    }
});